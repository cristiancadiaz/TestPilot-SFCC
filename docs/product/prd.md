...
Antes de redactar el PRD se realizó un cruce exhaustivo de 3 documentos de investigación, hoy ubicados en `docs/research/` (`hcai-c2-internal-solution-brief.md`, `deep-research-validacion.md`, `deep-research-critica.md`). Se identificaron 7 conflictos y 5 vacíos. Estas son las decisiones estructurales que moldean el resto del PRD.
